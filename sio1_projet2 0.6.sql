...
(21, 'Szmundy', 'Adam', '10', 'Escautpont', 59278, '659300454', 'test', '$2y$10$Ile72Ztjth1xUOLtbjNP1O1uVecYlJzY9RBbrbldsTTCxiTqxGCVC', '2024-03-18', 'L59003');
...
INSERT INTO `documentaliste` (`iddocumentaliste`, `nom`, `prenom`, `mail`, `mdp`, `matricule`, `idbibliotheque`) VALUES
(1, 'Liebecq', 'Aurélien', 'racisme@gmail.com', '$2y$10$Ile72Ztjth1xUOLtbjNP1O1uVecYlJzY9RBbrbldsTTCxiTqxGCVC', 100, 'L59003');
...
INSERT INTO `emprunt` (`date_debut`, `date_fin`, `adherent_idadherent`, `livre_idlivre`, `etat`) VALUES
('2021-12-06', '2022-06-06', 1, '001_001', NULL),
('2021-06-10', '2021-12-10', 12, '002_001', NULL),
('2021-12-21', '2022-06-21', 20, '002_003', NULL),
('2021-09-01', '2022-03-01', 12, '003_001', NULL),
('2021-09-01', '2022-03-01', 7, '004_002', NULL),
('2021-01-18', '2021-09-18', 3, '005_001', NULL),
('2021-06-21', '2021-12-21', 16, '006_001', NULL),
('2021-03-28', '2022-03-28', 7, '008_001', NULL),
('2021-03-15', '2021-12-15', 9, '010_001', NULL),
('2022-01-05', '2022-04-05', 11, '010_002', NULL),
('2021-12-20', '2022-06-20', 9, '011_001', NULL),
('2021-11-06', '2022-05-06', 18, '012_001', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `etatemprunt`
--

CREATE TABLE `etatemprunt` (
  `idEmprunt` int(1) NOT NULL,
...
--
-- Index pour la table `etatemprunt`
--
ALTER TABLE `etatemprunt`
...
--
ALTER TABLE `adherent`
  MODIFY `idadherent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
ALTER TABLE `emprunt`
  ...
  ADD CONSTRAINT `fk_etat` FOREIGN KEY (`etat`) REFERENCES `etatemprunt` (`idEmprunt`);
