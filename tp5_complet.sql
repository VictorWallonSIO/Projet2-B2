...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 07 mars 2023 à 14:28
...
--
CREATE DATABASE IF NOT EXISTS `sio1_tp5` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sio1_tp5`;
...
INSERT INTO `adherent` (`idadherent`, `nom_adherent`, `prenom_adherent`, `rue`, `ville`, `code_postal`, `telephone`, `date_inscription`, `bibliotheque_idbibliotheque`) VALUES
